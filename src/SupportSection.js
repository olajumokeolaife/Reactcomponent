...
import SupportItem from "../src/SupportItem";
...
const SupportSection = () => {
  const SupportItems = [
    {
      icon: require("../src/images/schl.png"),
      title: "Scholarships",
      description:
    ...
    {
      icon: require("../src/images/free.png"),
    ...
    {
      icon: require("../src/images/hildpng.png"),
    ...
    {
      icon: require("../src/images/560png.png"),
    ...
    {
      icon: require("../src/images/dedipng.png"),
    ...
    {
      icon: require("../src/images/xclupng.png"),
    ...
    {
      icon: require("../src/images/7000.png"),
